...
#' @examples
#' \dontrun{
#' dumbecol<-MapEcol64.camp(1,999,Nsh[25:30],"cant","local",ind="n",bw=TRUE,indec="simp",out.dat=TRUE,layout=c(2,3))
...
#' @family ecologia
#' @export
MapEcol64.camp<-function(gr,esp="999",camp,zona="cant",dns=c("local","serv"),ind="n",indec="div",plot=TRUE,bw=FALSE,
